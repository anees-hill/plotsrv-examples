...
def plot_cpu_percent_plotnine(data: pl.DataFrame):
    ...
    publish_artifact(p, label="CPU%", section="plotnine", host="127.0.0.1", port=8000)
...
def plot_cpu_percent_matplotlib(data: pl.DataFrame):
    ...
    publish_artifact(
        fig, label="CPU%", section="matplotlib", host="127.0.0.1", port=8000
    )
...
def plot_cpu_percent_seaborn(data: pl.DataFrame):
    ...
    publish_artifact(fig, label="CPU%", section="seaborn", host="127.0.0.1", port=8000)
...
def plot_mem_used_plotnine(data: pl.DataFrame):
    ...
    publish_artifact(
        p, label="MEM-USED", section="plotnine", host="127.0.0.1", port=8000
    )
...
def plot_mem_used_seaborn(data: pl.DataFrame):
    ...
    publish_artifact(
        fig, label="MEM-USED", section="seaborn", host="127.0.0.1", port=8000
    )
