...
@plotsrv(label="Tabular view", section="polars", host="127.0.0.1", port=8000)
...
@plotsrv(label="Tabular view", section="pandas", host="127.0.0.1", port=8000)
...
@plotsrv(label="CPU%", section="plotnine", host="127.0.0.1", port=8000)
...
@plotsrv(label="CPU%", section="matplotlib", host="127.0.0.1", port=8000)
...
@plotsrv(label="CPU%", section="seaborn", host="127.0.0.1", port=8000)
...
@plotsrv(label="MEM-USED", section="plotnine", host="127.0.0.1", port=8000)
...
@plotsrv(label="MEM-USED", section="matplotlib", host="127.0.0.1", port=8000)
...
@plotsrv(label="MEM-USED", section="seaborn", host="127.0.0.1", port=8000)
