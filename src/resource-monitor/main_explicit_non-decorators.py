...
from plotsrv import publish_view, plot_launch
...
def system_snapshot_polars(interval: float = 1) -> pl.DataFrame:
    ...
    publish_view(
        row, label="Tabular view", section="polars", host="127.0.0.1", port=8000
    )
...
def system_snapshot_pandas(interval: float = 1):
    ...
    publish_view(
        df, label="Tabular view", section="pandas", host="127.0.0.1", port=8000
    )
...
def plot_cpu_percent_plotnine(data: pl.DataFrame):
    ...
    plot_launch(p, label="CPU%", section="plotnine", host="127.0.0.1", port=8000)
...
def plot_cpu_percent_matplotlib(data: pl.DataFrame):
    ...
    plot_launch(fig, label="CPU%", section="matplotlib", host="127.0.0.1", port=8000)
...
def plot_cpu_percent_seaborn(data: pl.DataFrame):
    ...
    plot_launch(fig, label="CPU%", section="seaborn", host="127.0.0.1", port=8000)
...
def plot_mem_used_plotnine(data: pl.DataFrame):
    ...
    plot_launch(p, label="MEM-USED", section="plotnine", host="127.0.0.1", port=8000)
...
def plot_mem_used_matplotlib(data: pl.DataFrame):
    ...
    plot_launch(
        fig, label="MEM-USED", section="matplotlib", host="127.0.0.1", port=8000
    )
...
def plot_mem_used_seaborn(data: pl.DataFrame):
    ...
    plot_launch(fig, label="MEM-USED", section="seaborn", host="127.0.0.1", port=8000)
